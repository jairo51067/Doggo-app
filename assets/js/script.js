// ============================================
// DOGGO-APP SPA ROUTER - VERSIÓN FINAL v5.0.0
// ============================================
...
class Router {
  ...
  initPedidoForm() {
    ...
    this.initBebidasQuantities(form); // ✅ NUEVO: Inicializar bebidas
  ...
  // ✅ NUEVO MÉTODO: Cantidades de Bebidas
  ...
  // --- Envío del Formulario (CON BEBIDAS) ---
  initFormSubmit(form) {
  ...
  // --- Actualizar Resumen (CON BEBIDAS) ---
  updateSummary() {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log("🐕 ¡Doggo App iniciada! v5.0.0");
