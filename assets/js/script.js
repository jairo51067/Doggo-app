// ============================================
// DOGGO-APP SPA ROUTER - VERSIÓN FINAL v6.0.3
// ============================================
...
class Router {
    ...
    initPedidoForm() {
        ...
        // ❌ Eliminado: this.initClearCart(form);
    ...
    // initClearCart eliminado - ya no se usa
    ...
    // ✅ FUNCIÓN CLEAR CART CORREGIDA
      clearCart() {
        ...
        // 11. ✅ REINICIAR STEPPER USANDO initStepper (que ya existe)
        // Primero limpiamos las clases visuales
        form.querySelectorAll('.step-content').forEach(step => {
            step.classList.remove('active');
        });
        form.querySelectorAll('.step-indicator').forEach(indicator => {
            indicator.classList.remove('active', 'completed');
        });
        form.querySelectorAll('.step-line').forEach(line => {
            line.classList.remove('completed');
        });

        // Luego llamamos a initStepper para que configure todo desde cero
        this.initStepper(form);
        ...
        const steps = this.form?.querySelectorAll('.step-content') || document.querySelectorAll('.step-content');
        const indicators = this.form?.querySelectorAll('.step-indicator') || document.querySelectorAll('.step-indicator');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('🐕 ¡Doggo App iniciada! v6.0.3');
