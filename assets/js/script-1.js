...
class Router {
  ...
  initPedidoForm() {
    ...
    this.initQuantities(form, ".doggo-card", "doggos", ".qty-value", "has-items");
    this.initQuantities(form, ".extra-chip", "extras", ".qty-value-mini", "has-items");
    this.initQuantities(form, ".bebida-card", "bebidas", ".qty-value-mini", "has-items");
